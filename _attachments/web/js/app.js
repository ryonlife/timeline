...
(function(/*! Stitch !*/) {
...
}, "lib/timeline_backbone": function(exports, require, module) {(function() {
  exports.Timeline = {
    ...
    sync: function(method, model, options) {
      ...
      params.url = Timeline.API + (!params.url ? getUrl(model) : params.url);
      if (!params.data && model && (method === 'create' || method === 'update')) {
        params.data = JSON.stringify(model.toJSON());
      }
      return $.ajax(params);
  ...
  exports.MemoriesShowView = (function() {
    ...
    MemoriesShowView.prototype.editMemory = function(e) {
      e.preventDefault();
    ...
    MemoriesShowView.prototype.cancelUpdateTitleDescription = function(e) {
    ...
    MemoriesShowView.prototype.selfTag = function(e) {
      ...
      return $('a#tag_friends').removeClass('hide').trigger('friendSelection', [
        [
          {
            id: USER.ME.id,
            name: USER.ME.name,
