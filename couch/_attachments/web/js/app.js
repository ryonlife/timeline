...
(function(/*! Stitch !*/) {
...
}).call(this)({"controllers/home_controller": function(exports, require, module) {(function() {
...
}, "controllers/memories_controller": function(exports, require, module) {(function() {
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  var memoriesShowPhotoSelectorTemplate;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.MemoriesShowPhotoSelectorView = (function() {
    ...
    MemoriesShowPhotoSelectorView.prototype.events = {
    ...
    MemoriesShowPhotoSelectorView.prototype.selectSource = function(e) {
      var $el;
      e.preventDefault();
      $el = $(e.currentTarget);
      if (!$el.hasClass('selected')) {
        this.reset();
        return $el.parent().addClass('selected');
      }
    };
    ...
    MemoriesShowPhotoSelectorView.prototype.infinityScroll = function(e, url) {
      ...
      if ((this.state.page === 1 || 700 >= Math.ceil($el.find('li').length / 3) * 140 - $el.scrollTop()) && !this.state.pendingRequest && !this.state.maxReached) {
        ...
        return FB.api(url, {
          ...
          return this.state.pendingRequest = false;
        }, this));
      }
    };
    ...
    return MemoriesShowPhotoSelectorView;
  })();
}).call(this);
  ...
  exports.MemoriesShowView = (function() {
      ...
      steps = [
        {
          ...
          target: $('[data-step=2]'),
          title: 'Step 2: Date',
          content: '<p>When did it happen?</p><p>Click <strong>May 26, 2011</strong>, then use the calendar to select the date when your memory took place.</p>'
        }, {
          target: $('[data-step=3]'),
          title: 'Step 3: Friends',
          content: '<p>Who was there?</p><p>Click the <strong>Tag Friends</strong> button to select the friends you shared this memory with.</p>'
        }
      ];
      _.each(steps, function(step, i) {
        if (i) {
          if (i === 1) {
            ...
            return steps[i].content += "<p class=\"clearfix tar\"><a href=\"#\" id=\"prev\">&laquo; Step " + i + "</a>&nbsp;|&nbsp;<a href=\"#\" id=\"next\" class=\"fr\">Step " + (i + 1) + " &raquo;</a></p>";
          }
        }
      });
      $(this.el).qtip({
    ...
    MemoriesShowView.prototype.showGallery = function(e) {
      var $pic;
      e.preventDefault();
      $pic = $(e.target);
